...
// Utility: create a Sprite from a canvas-rendered label
...
export default function HeroThree({
  ...
  useEffect(() => {
    ...
    scene.fog = new THREE.FogExp2(0x020617, 0.08); // near-black blue
    ...
    // Orbiting keyword sprites
    const group = new THREE.Group();
    scene.add(group);
    const sprites: { sprite: THREE.Sprite; radius: number; speed: number; phase: number }[] = [];
    ...
    const animate = () => {
      ...
      // Subtle group rotation and star drift
